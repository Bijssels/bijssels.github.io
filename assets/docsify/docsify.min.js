!function () {
    ...
    function g(e) {
        ...
        return "string" == typeof n[1] && 0 < n[1].length &&
                n[1].toLowerCase() !== location.protocol ||
            ("string" == typeof n[2] && 0 < n[2].length &&
                    n[2].replace(
                            new RegExp(
                                ":(" +
                                    {
                            ...
                            "",
                        ) !== location.host || !!/^\/\\/.test(e));
    }
    var s = document.body.clientWidth <= 600,
        t = window.history && window.history.pushState &&
        ...
        D = function (n) {
            ...
            return n && (e.__proto__ = n),
                ...
                e.prototype.onchange = function (i) {
                    void 0 === i && (i = d),
                        p("click", function (e) {
                            var n = "A" === e.target.tagName
                                ? e.target
                                : e.target.parentNode;
                            n && "A" === n.tagName && !g(n.href) &&
                                (e.preventDefault(),
                                    n = n.href,
    ...
    function G(e) {
        ...
        Z || ((e = w("div")).classList.add("progress"), r(h, e), Z = e),
            n = t
                ? 80 < (n = parseInt(Z.style.width || 0, 10) + t) ? 80 : n
                : Math.floor(i / o * 100),
            Z.style.opacity = 1,
    ...
    var ae = (function (e, n, i) {
        ...
        key: "begin",
        value: function () {
            return this.isRunning || this.next === this.end ||
    ...
    function ue(e) {
        var n,
            ...
            o = ce ||
                [].slice.call(document.getElementsByTagName("script")).filter(
                    function (e) {
    ...
    function le(e) {
        if (ge) {
            ...
            !n ||
                (r = fe[ve(e, n.getAttribute("data-id"))]) && r !== a &&
                    (a && a.classList.remove("active"),
                        r.classList.add("active"),
                        a = r,
                        !pe && h.classList.contains("sticky") &&
                        (e = i.clientHeight,
                            r = a.offsetTop + a.clientHeight + 40,
                            a = a.offsetTop >= t.scrollTop &&
                                r <= t.scrollTop + e,
                            i.scrollTop = a
                                ? t.scrollTop
                                : +r < e
        ...
        n && (o = ue().topMargin,
            (i = b("#" + n)) && (i = i,
                ...
                de = new ae({
                    ...
                    end: Math.round(i.getBoundingClientRect().top) +
    ...
    var me = "undefined" != typeof globalThis
        ? globalThis
    ...
    function qe(e, n) {
        ...
        return "//" === n.substring(0, 2)
            ? i ? n : e.replace(Le, "$1") + n
            : "/" === n.charAt(0)
            ? i ? n : e.replace(Oe, "$1") + n
            : e + n;
    }
    function Pe(e, n, i) {
        var o = e.length;
    ...
    var Me = function (e, n) {
            if (n) { if (ye.test(e)) return e.replace(xe, ke); }
        ...
        He = function (e, n, i) {
            if (e) {
                ...
                if (
                    ...
                    0 === o.indexOf("vbscript:") || 0 === o.indexOf("data:")
                ) return null;
            }
    ...
    var nn = function () {
            ...
            return e.prototype.space = function (e) {
                ...
                e.prototype.def = function (e) {
                    ...
                    if (e) {
                        return e[3] &&
                            (e[3] = e[3].substring(1, e[3].length - 1)),
                            {
    ...
    Ne.def = Ve(Ne.def).replace("label", Ne._label).replace("title", Ne._title)
        .getRegex(),
        Ne.bullet = /(?:[*+-]|\d{1,9}[.)])/,
        Ne.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/,
        Ne.item = Ve(Ne.item, "gm").replace(/bull/g, Ne.bullet).getRegex(),
        Ne.listItemStart = Ve(/^( *)(bull)/).replace("bull", Ne.bullet)
            .getRegex(),
        Ne.list = Ve(Ne.list).replace(/bull/g, Ne.bullet).replace(
            "hr",
            "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))",
        ...
        Ne._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/,
        Ne.html = Ve(Ne.html, "i").replace("comment", Ne._comment).replace(
            "tag",
            Ne._tag,
        ).replace(
            "attribute",
        ...
        Ne.paragraph = Ve(Ne._paragraph).replace("hr", Ne.hr).replace(
            "heading",
            " {0,3}#{1,6} ",
        ).replace("|lheading", "").replace("blockquote", " {0,3}>").replace(
            "fences",
            " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n",
        ).replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace(
            "html",
            "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)",
        ).replace("tag", Ne._tag).getRegex(),
        Ne.blockquote = Ve(Ne.blockquote).replace("paragraph", Ne.paragraph)
            .getRegex(),
        Ne.normal = De({}, Ne),
        Ne.gfm = De({}, Ne.normal, {
            nptable:
        ...
        Ne.gfm.nptable = Ve(Ne.gfm.nptable).replace("hr", Ne.hr).replace(
            "heading",
            " {0,3}#{1,6} ",
        ...
        Ne.gfm.table = Ve(Ne.gfm.table).replace("hr", Ne.hr).replace(
            "heading",
            " {0,3}#{1,6} ",
        ).replace("blockquote", " {0,3}>").replace("code", " {4}[^\\n]")
            .replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n")
        ...
        Ne.pedantic = De({}, Ne.normal, {
            html: Ve(
                "^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))",
            ).replace("comment", Ne._comment).replace(
                /tag/g,
            ...
            heading: /^(#{1,6})(.*)(?:\n+|$)/,
            fences: Ze,
            paragraph: Ve(Ne.normal._paragraph).replace("hr", Ne.hr).replace(
                "heading",
                " *#{1,6} *[^\n]",
            ).replace("lheading", Ne.lheading).replace("blockquote", " {0,3}>")
                .replace("|fences", "").replace("|list", "").replace(
                    "|html",
                    "",
                ).getRegex(),
        });
    ...
    Ze.punctuation = Ve(Ze.punctuation).replace(/punctuation/g, Ze._punctuation)
        .getRegex(),
        Ze._blockSkip = "\\[[^\\]]*?\\]\\([^\\)]*?\\)|`[^`]*?`|<[^>]*?>",
        Ze._overlapSkip = "__[^_]*?__|\\*\\*\\[^\\*\\]*?\\*\\*",
        Ze._comment = Ve(Ne._comment).replace("(?:--\x3e|$)", "--\x3e")
            .getRegex(),
        Ze.em.start = Ve(Ze.em.start).replace(/punctuation/g, Ze._punctuation)
            .getRegex(),
        Ze.em.middle = Ve(Ze.em.middle).replace(/punctuation/g, Ze._punctuation)
            .replace(/overlapSkip/g, Ze._overlapSkip).getRegex(),
        Ze.em.endAst = Ve(Ze.em.endAst, "g").replace(
            /punctuation/g,
            Ze._punctuation,
        ).getRegex(),
        Ze.em.endUnd = Ve(Ze.em.endUnd, "g").replace(
            /punctuation/g,
            Ze._punctuation,
        ).getRegex(),
        Ze.strong.start = Ve(Ze.strong.start).replace(
            /punctuation/g,
            Ze._punctuation,
        ).getRegex(),
        Ze.strong.middle = Ve(Ze.strong.middle).replace(
            /punctuation/g,
            Ze._punctuation,
        ).replace(/overlapSkip/g, Ze._overlapSkip).getRegex(),
        ...
        Ze.strong.endUnd = Ve(Ze.strong.endUnd, "g").replace(
            /punctuation/g,
            Ze._punctuation,
        ).getRegex(),
        ...
        Ze.autolink = Ve(Ze.autolink).replace("scheme", Ze._scheme).replace(
            "email",
            Ze._email,
        ).getRegex(),
        Ze._attribute =
            /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,
        Ze.tag = Ve(Ze.tag).replace("comment", Ze._comment).replace(
            "attribute",
            Ze._attribute,
        ).getRegex(),
        Ze._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,
        ...
        Ze._title =
            /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
        Ze.link = Ve(Ze.link).replace("label", Ze._label).replace(
            "href",
            Ze._href,
        ).replace("title", Ze._title).getRegex(),
        Ze.reflink = Ve(Ze.reflink).replace("label", Ze._label).getRegex(),
        Ze.reflinkSearch = Ve(Ze.reflinkSearch, "g").replace(
            "reflink",
            Ze.reflink,
        ).replace("nolink", Ze.nolink).getRegex(),
        Ze.normal = De({}, Ze),
        Ze.pedantic = De({}, Ze.normal, {
            ...
            link: Ve(/^!?\[(label)\]\((.*?)\)/).replace("label", Ze._label)
                .getRegex(),
            reflink: Ve(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(
                "label",
                Ze._label,
            ).getRegex(),
        }),
        ...
        Ze.gfm.url = Ve(Ze.gfm.url, "i").replace(
            "email",
            Ze.gfm._extended_email,
        ).getRegex(),
        Ze.breaks = De({}, Ze.gfm, {
    ...
    function un(e) {
        for (var n, i = "", o = e.length, t = 0; t < o; t++) {
            n = e.charCodeAt(t),
                i += "&#" +
                    (n = .5 < Math.random() ? "x" + n.toString(16) : n) + ";";
        }
        return i;
    }
    var fn = function () {
            ...
            return e.rules.get = function () {
                ...
                i.prototype.inlineTokens = function (e, n, i, o) {
                    ...
                    if (this.tokens.links) {
                        ...
                        if (0 < f.length) {
                            for (
                                ;
                                null !=
                                    (a = this.tokenizer.rules.inline
                                        .reflinkSearch.exec(u));
                            ) {
                                f.includes(
                    ...
                    for (; e;) {
                        if (
                            r || (c = ""), r = !1, t = this.tokenizer.escape(e)
        ...
        sn = function () {
            ...
            return e.prototype.code = function (e, n, i) {
                ...
                return !this.options.highlight ||
                    null != (n = this.options.highlight(e, o)) && n !== e &&
                        (i = !0, e = n),
                    e = e.replace(/\n$/, "") + "\n",
                    o
                        ? '<pre><code class="' + this.options.langPrefix +
                            gn(o, !0) + '">' + (i ? e : gn(e, !0)) +
                            "</code></pre>\n"
                        : "<pre><code>" + (i ? e : gn(e, !0)) +
                            "</code></pre>\n";
                ...
                e.prototype.heading = function (e, n, i, o) {
                    return this.options.headerIds
                        ? "<h" + n + ' id="' + this.options.headerPrefix +
                            o.slug(i) + '">' + e + "</h" + n + ">\n"
                        : "<h" + n + ">" + e + "</h" + n + ">\n";
                },
        ...
        xn.walkTokens = function (e, n) {
            for (var i = 0, o = e; i < o.length; i += 1) {
                ...
                switch (n(t), t.type) {
                    case "table":
                        for (
                            var a = 0, r = t.tokens.header; a < r.length; a += 1
                        ) {
                            var c = r[a];
                            xn.walkTokens(c, n);
                        }
                        for (
                            var u = 0, f = t.tokens.cells; u < f.length; u += 1
                        ) {
    ...
    function An(e, i) {
        ...
        return e.forEach(function (e) {
            ...
            o += '<li><a class="section-link" href="' + e.slug + '" title="' +
                n + '">' + e.title + "</a></li>",
    ...
    function Tn(e) {
        ...
        var n = e.trim().replace(/[A-Z]+/g, Rn).replace(/<[^>]+>/g, "").replace(
                En,
                "",
        ...
        return e.replace(
            ...
            return i = e,
                ...
                i = n
                    ? e && /unicode/.test(n)
                        ? '<span class="emoji">' +
                            n.replace("unicode/", "").replace(/\.png.*/, "")
                                .split("-").map(function (e) {
                                    return "&#x" + e + ";";
                                }).join("&zwj;").concat("&#xFE0E;") +
                            "</span>"
                        : '<img src="' + Cn.baseURL + n + '.png" alt="' + o +
        ...
        Pn = be(function (e) {
            var u,
                ...
                g = function (u) {
                    ...
                    function L(e, n, i) {
                        for (
                            var o = n.next, t = 0; t < i && o !== e.tail; t++
                        ) o = o.next;
            ...
            e.exports && (e.exports = g),
                ...
                void 0 !== g && "undefined" != typeof document &&
                (Element.prototype.matches ||
                    ...
                    d = "pre[data-src]:not([" + (f = "data-src-status") +
                        '="loaded"]):not([' + f + '="' + (p = "loading") +
                        '"])',
                    ...
                    g.hooks.add("before-sanity-check", function (e) {
                        ...
                        c.matches(d) && (e.code = "",
                            c.setAttribute(f, p),
                            (t = c.appendChild(document.createElement("CODE")))
                                .textContent = "Loading…",
    ...
    function In(t, e) {
        ...
        this.config = t,
            ...
            this.linkRel = "_blank" === this.linkTarget
    ...
    var Nn = {},
        Hn = {
            ...
            iframe: function (e, n) {
                return {
                    html: '<iframe src="' + e + '" ' +
                        (n || "width=100% height=400") + "></iframe>",
                };
            },
            video: function (e, n) {
                return {
                    html: '<video src="' + e + '" ' + (n || "controls") +
                        ">Not Support</video>",
                };
            },
            audio: function (e, n) {
                return {
                    html: '<audio src="' + e + '" ' + (n || "controls") +
                        ">Not Support</audio>",
                };
            },
            code: function (e, n) {
    ...
    In.prototype.compileEmbed = function (e, n) {
        ...
        if (n = a, t.include) {
            return R(e) ||
                (e = q(this.contentBase, C(this.router.getCurrentPath()), e)),
                t.type && (o = Hn[t.type])
        ...
        In.prototype._initRenderer = function () {
            ...
            return t.heading = e.heading = function (e, n) {
                ...
                return e.slug = t,
                    g.toc.push(e),
                    "<h" + n + ' id="' + i + '"><a href="' + t + '" data-id="' +
                    i + '" class="anchor"><span>' + o + "</span></a></h" + n +
                    ">";
            },
                t.code = { renderer: e }.renderer.code = function (e, n) {
                    var i = Pn.languages[n = void 0 === n ? "markup" : n] ||
                        Pn.languages.markup;
                    return '<pre v-pre data-lang="' + n +
                        '"><code class="lang-' + n + '">' +
                    ...
                    (i = (n = {
                        ...
                        i.link = function (e, n, i) {
                            ...
                            return u = t.target || u,
                                ...
                                t.disabled &&
                                (o.push("disabled"), e = "javascript:void(0)"),
                ...
                t.paragraph = { renderer: e }.renderer.paragraph = function (
                    e,
                ) {
                    e = /^!&gt;/.test(e)
                        ? $n("tip", e)
                ...
                t.listitem = { renderer: e }.renderer.listitem = function (e) {
                    return /^(<input.*type="checkbox"[^>]*>)/.test(e)
                        ? '<li class="task-list-item"><label>' + e +
                            "</label></li>"
                        : "<li>" + e + "</li>";
                },
                e.origin = t,
            ...
            if (e) t = this.compile(e);
                ...
                for (var a = 0; a < i.length; a++) {
                    if (i[a].ignoreSubHeading) {
                        ...
                        i.splice(a, 1);
                        for (
                            var c = a; c < i.length && r < i[c].level; c++
                        ) i.splice(c, 1) && c-- && a++;
                        a--;
                    }
                }
            ...
            ? (a = [],
                ...
                (o = i).replace(V, function (n, e, i) {
                    a.push(o.substring(r, i - 1)),
                        ...
                        a.push(
                            t && t[n] || function (e) {
                                return ("00" + ("string" == typeof Y[n]
                                    ? e[Y[n]]()
                                    : Y[n](e))).slice(-n.length);
                            },
                        );
                }),
    ...
    function Gn(e) {
        ...
        var i = this.config,
            ...
            t = "Vue" in window && window.Vue.version &&
        ...
        if (
            this._renderTo(o, e),
                ...
                (i.executeScript ||
                    "Vue" in window && !1 !== i.executeScript) &&
            ...
            2 === t && d.length && d.forEach(function (e) {
                ...
                (i.vueGlobalOptions || d.length) && (u = /{{2}[^{}]*}{2}/,
                    ...
                    p.push.apply(
                        p,
                        k(".markdown-section > *").filter(function (i) {
                            ...
                            return e.tagName.toLowerCase() in
                                    (i.vueComponents || {}) ||
                                e.querySelector(d.join(",") || null) ||
                                u.test(e.outerHTML) || f.test(e.outerHTML);
                        }).map(function (e) {
            ...
            for (var g = 0, s = p; g < s.length; g += 1) {
                ...
                h.matches("pre, script") || n(h) ||
                    h.querySelector("[" + v + "]") || (h.setAttribute(v, ""),
                        2 === t
                ...
                function (e) {
                    ...
                    return e && (n.__proto__ = e),
                        ((n.prototype = Object.create(e && e.prototype))
                            .constructor = n).prototype._loadSideAndNav =
                                function (e, n, i, o) {
                                    var t = this;
                                    return function () {
                                        if (!i) {
                        ...
                        n.prototype._fetch404 = function (e, n, i) {
                            ...
                            if (t) {
                                ...
                                return Kn(this.router.getFile(e), 0, r).then(
                                    function (e, n) {
                    ...
                    return e && (n.__proto__ = e),
                        ((n.prototype = Object.create(e && e.prototype))
                            .constructor = n).prototype.$resetEvents =
                                function (e) {
                            ...
                            e = "button.sidebar-toggle",
                                ...
                                (p(e, "click", function (e) {
                                    ...
                                    s && p(h, "click", function (e) {
                                        return h.classList.contains("close") &&
                                            n();
                                    })),
                                e = ".sidebar",
                                this.router,
                    ...
                    return e && (n.__proto__ = e),
                        ...
                        n.prototype._renderNav = function (e) {
                            e &&
                            this._renderTo("nav", this.compiler.compile(e)),
                                this.config.loadNavbar &&
                                ee(this.router, "nav");
                        },
                    ...
                    return e && (n.__proto__ = e),
                        ((n.prototype = Object.create(e && e.prototype))
                            .constructor = n).prototype.routes = function () {
                    ...
                    return e && (n.__proto__ = e),
                        ((n.prototype = Object.create(e && e.prototype))
                            .constructor = n).prototype.initLifecycle =
                                function () {
                                    var i = this;
                                    this._hooks = {},
                                        this._lifecycle = {},
